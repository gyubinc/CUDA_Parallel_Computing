...
# Lab assignment 3 - CUDA Tiled Convolution with CUDA Streams and Pinned Memory 
...
The following will compile the template file that you will modify to implement tiled convolution using CUDA streams in CUDA. 
